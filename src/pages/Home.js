...
const Home = () => {
  ...
  return (
    <div className="home">
      <img src="/logo.webp" alt="AR Rovighi logo" className="home-image" />
      <div className="home-content">
        ...
        <div className="home-carousel">
          <Slider {...settings}>
            <div><img src="/negozio.webp" alt="Orologio 1" className="carousel-image" /></div>
            <div><img src="/riparazione.webp" alt="Orologio 2" className="carousel-image" /></div>
            <div><img src="/riparazione2.webp" alt="Orologio 3" className="carousel-image" /></div>
            <div><img src="/orologi.webp" alt="Orologio 3" className="carousel-image" /></div>
            <div><img src="/orologi2.webp" alt="Orologio 3" className="carousel-image" /></div>
            {/* Aggiungi altre immagini qui se necessario */}
          </Slider>
        </div>
        <script src="https://static.elfsight.com/platform/platform.js" data-use-service-core defer></script>
        <div class="elfsight-app-d9b4ea73-aec4-43aa-9f25-6d63db0728c7" data-elfsight-app-lazy></div>
      </div>
    </div>
  );
}
